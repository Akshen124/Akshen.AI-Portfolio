...
export default function Footer() {
    ...
    return (
        ...
        <footer className="relative overflow-hidden border-t border-purple-500/20 py-12">
            ...
            <div className="pointer-events-none absolute bottom-0 left-0 w-[300px] h-[300px] bg-purple-700/20 rounded-full blur-[150px]" />

            <div className="pointer-events-none absolute top-0 right-0 w-[250px] h-[250px] bg-blue-700/10 rounded-full blur-[120px]" />
                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <a href="https://www.linkedin.com/in/akshen-s-732a35268/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="inline-flex w-11 h-11 min-w-[44px] min-h-[44px] rounded-full bg-zinc-900 border border-purple-500/20 items-center justify-center hover:border-purple-500 hover:bg-purple-500/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-400 transition-touch">

                                <Image src="/linkedin-logo.svg" alt="LinkedIn" width={24} height={24} />

                            </a>

                            <a href="https://github.com/Akshen124/" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="inline-flex w-11 h-11 min-w-[44px] min-h-[44px] rounded-full bg-zinc-900 border border-purple-500/20 items-center justify-center hover:border-purple-500 hover:bg-purple-500/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-400 transition-touch">

                                <Image src="/github-logo.svg" alt="GitHub" width={35} height={35} />

                            </a>

                            <a href="https://wa.me/918531899895" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="inline-flex w-11 h-11 min-w-[44px] min-h-[44px] rounded-full bg-zinc-900 border border-purple-500/20 items-center justify-center hover:border-purple-500 hover:bg-purple-500/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-400 transition-touch">
